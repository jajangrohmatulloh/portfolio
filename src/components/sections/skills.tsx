...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["MySQL", "PostgreSQL", "MongoDB", "Redis", "Elasticsearch", "Supabase", "Firebase", "Vite", "Webpack", "Kafka", "Docker", "Git", "GitHub", "Jira", "Confluence", "Cursor", "Claude Code", "GitHub Copilot"],
  },
];
