...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["MySQL", "PostgreSQL", "MongoDB", "Redis", "Elasticsearch", "Supabase", "Firebase", "ESLint", "Vite", "Webpack", "Kafka", "Docker", "Git", "GitHub", "Jira", "Confluence", "Cursor", "Claude Code", "GitHub Copilot"],
  },
];
