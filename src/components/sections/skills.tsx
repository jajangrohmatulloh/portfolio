...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["Java", "Go", "Node.js", "NestJS", "Express.js", "Python", "PHP", "Laravel", "Spring Boot", "REST API", "SQL", "NoSQL"],
  },
  {
    ...
    skills: ["MySQL", "PostgreSQL", "MongoDB", "Redis", "Docker", "Kafka", "Figma", "Git", "Salesforce", "WordPress"],
  },
];
