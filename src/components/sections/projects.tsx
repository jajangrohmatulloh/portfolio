...
const projects = [
  ...
  },
  {
    ...
    tags: ["Vue.js", "TypeScript", "TailwindCSS", "Supabase", "Pinia", "API Integration", "AI"],
  ...
  },
  {
    ...
    tags: ["Node.js", "Express.js", "Socket.IO", "TikTok Live Connector", "Text-to-Speech"],
  ...
  },
  {
    ...
    description: "An internal tool with a React web client and a separate React Native Android app for composing Advance.ai API requests and viewing responses.",
    tags: ["React", "React Native", "TypeScript", "JavaScript", "Node.js", "Bootstrap", "API Integration"],
