            ...
            <div className="pt-4">
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <a
                  ...
                  title="GitHub"
                >
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-slate-700 to-slate-900 dark:from-slate-600 dark:to-slate-800 flex items-center justify-center text-white shadow-lg hover:shadow-2xl hover:shadow-slate-500/40 transition-all duration-300 hover:scale-110 hover:-translate-y-1 cursor-pointer">
                    <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                    <span className="text-xs font-medium text-slate-600 dark:text-slate-400">GitHub</span>
                  </div>
                </a>
              </div>
            </div>
