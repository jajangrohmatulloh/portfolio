...
const contactEmail = "jajangrohmatulloh57@gmail.com";
...
const contactMethods = [
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/jajangrohmatulloh",
...
function EmailContactCard() {
  return (
    ...
    >
      <div className="rounded-[calc(1rem-1px)] bg-gradient-to-br from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-900 p-4">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 text-white shadow-md">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-sm font-semibold text-slate-900 dark:text-white transition-colors">
              {contactEmail}
            </p>
          </div>
        </div>
    ...
    <section id="contact" className="py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-5xl mx-auto">
          {/* Contact Info Card - Takes 2 columns */}
          <motion.div
          ...
          >
            <Card className="h-full border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden">
              <CardHeader className="border-b border-slate-100 dark:border-slate-800 pb-6">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white shadow-lg mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {/* Email - highlighted as the primary contact */}
                  <motion.div
                  ...
                  {contactMethods.slice(1).map((method) => (
                    <a
                      ...
                      className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-slate-50/50 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-500 hover:bg-white hover:shadow-lg dark:border-slate-700 dark:bg-slate-800/50 dark:hover:bg-slate-800"
                      aria-label={`Contact via ${method.label}`}
                    >
                      <div className={`flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${method.gradient} text-white shadow-md transition-transform duration-300 group-hover:scale-110`}>
                        {method.icon}
                      </div>
                      <div className="min-w-0 flex-1">
                      ...
                      <svg className="h-5 w-5 flex-shrink-0 text-slate-400 transition-all duration-300 group-hover:translate-x-0.5 group-hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden">
              <CardHeader className="border-b border-slate-100 dark:border-slate-800 pb-6">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-12 h-12 shrink-0 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white shadow-lg mb-4">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
